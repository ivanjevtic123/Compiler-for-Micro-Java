...
public class Factor_DesignatorMeth extends FactorSub {

    private Designator Designator;
    private MayActPars MayActPars;

    public Factor_DesignatorMeth (Designator Designator, MayActPars MayActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("Factor_DesignatorMeth(\n");
